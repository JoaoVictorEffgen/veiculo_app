...
class AdminScreen extends ConsumerWidget {
  ...
  Future<void> _manageMaintenancePlan(BuildContext context, WidgetRef ref, AppUser admin, Vehicle vehicle) async {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          vehicle.hasMaintenancePlan
              ...
              : 'Nenhum plano anexado para este veiculo.',
        ),
        actions: [
    ...
    if (action == 'view' && vehicle.hasMaintenancePlan) {
    ...
    if (action == 'attach') {
      ...
      final error = await ref.read(adminControllerProvider.notifier).uploadMaintenancePlan(
            admin,
            vehicle.id,
            file.bytes!,
            file.name,
